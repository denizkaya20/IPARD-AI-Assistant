...
with st.sidebar:
    ...
    tedbir_options = {"Tümü": None, "101 — Tarımsal İşletmeler": "101", "103 — İşleme": "103", "201 — Çiftlik Faaliyetleri": "201", "202 — Köy Yenileme": "202", "302 — Çeşitlendirme": "302"}
    ...
    for ex in ["101 tedbirinde süt işletmesi için destek oranı nedir?", "Arıcılık projesi için minimum kovan sayısı kaçtır?", "Başvuru için gerekli belgeler nelerdir?"]:
